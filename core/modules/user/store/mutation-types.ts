...
export const USER_ADD_TO_PRODUCT_HISTORY = SN_USER + '/ADD_TO_PRODUCT_HISTORY'
export const USER_ORDER_STATUS_CHANGED = SN_USER + '/ORDER_STATUS_CHANGED'
export const USER_LOGIN = SN_USER + '/LOGIN_DATA_CHANGED'
export const USER_RESET_LOGIN = SN_USER + '/LOGIN_DATA_CLEARED'
export const USER_REGISTER = SN_USER + '/REGISTER_DATA_CHANGED'
export const USER_RESET_REGISTER = SN_USER + '/REGISTER_DATA_CLEARED'
