...
export const NewShipping = {
    ...
    data () {
        return {
            isFilled: false,
            personalDetails: this.$store.state.checkout.newShipping,
            createAccount: false,
    ...
    methods: {
        ...
        sendDataToCheckout () {
            ...
            this.$bus.$emit('checkout-after-newShipping', this.personalDetails, this.$v)
            this.isFilled = true
            this.isValidationError = false
        },
        edit () {
            if (this.isFilled) {
                this.$bus.$emit('checkout-before-edit', 'newShipping')
            }
        },
        gotoAccount () {
