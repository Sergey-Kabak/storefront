        ...
        <section class="row m0 between-xs">
          ...
          <div class="col-xs-12 col-md-5 data">
            ...
            >
              ...
              <span class="product-status" :class="productStatus.replace(/\s+/g , '')">{{ $t(productStatus) }}</span>
            </div>
            <h1
...
export default {
  ...
  data () {
    return {
      ...
      prevRoute: null,
      icons: {
        'In stock': `<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        'pending delivery': `<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        'coming_soon': `<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        'Not available': `<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  computed: {
    ...
    productStatusIcon () {
      return this.icons[this.productStatus]
    },
    productStatus () {
      if (this.getCurrentProduct.stock.is_in_stock && !!this.getCurrentProduct.preorder) {
        ...
        return 'In stock'
      } else if (!this.getCurrentProduct.stock.is_in_stock && !!this.getCurrentProduct.coming_soon) {
        return 'coming_soon'
      } else {
