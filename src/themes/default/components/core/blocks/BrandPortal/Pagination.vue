...
<script>
// https://github.com/SSENSE/vue-carousel/blob/master/src/Pagination.vue
export default {
  name: "pagination",
  inject: ["carousel"],
  computed: {
  ...
  methods: {
     ...
     */
    getDotTitle(index) {
      return this.carousel.$children && this.carousel.$children[index] && this.carousel.$children[index].title
