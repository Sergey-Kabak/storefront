<template>
  <router-link :event="getCompareProductsCount === 0 ? '' : 'click'" :to="localizedRoute('/compare')" class="compare-icon no-underline inline-flex" aria-label="addToCompare">
    ...
    <div v-if="getCompareProductsCount === 0" class="tooltip">
