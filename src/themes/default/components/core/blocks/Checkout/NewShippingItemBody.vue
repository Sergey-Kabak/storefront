<template>
  ...
  <div class="nav-link" :class="{active: type === method.method_code}">
    <div class="icon">

      <svg v-if="method.method_code === shippingType[0]" width="20" height="18" viewBox="0 0 20 18"
    ...
    <div class="text">
      <p class="main">{{ $t(method.method_title) }}</p>
    </div>
  </div>
