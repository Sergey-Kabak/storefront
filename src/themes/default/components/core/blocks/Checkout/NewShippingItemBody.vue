<template>
  ...
  <div class="nav-link" :class="{active: type === method.method_code}">
    <div class="icon">
      ...
      <svg v-if="method.method_code === 'flatrate'" width="20" height="18" viewBox="0 0 20 18"
      ...
      <svg v-if="method.method_code === 'tablerates'" width="20" height="20" viewBox="0 0 20 20"
           xmlns="http://www.w3.org/2000/svg">-->
      ...
      <svg v-if="method.method_code === 'freeshipping'" width="22" height="17" viewBox="0 0 22 17"
           xmlns="http://www.w3.org/2000/svg">
        <path
