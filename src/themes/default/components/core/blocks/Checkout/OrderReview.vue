        ...
        <div class="row mb15">
          <div class="col-xs-12">
            <div class="number-block d-flex align-items-center">
              <div class="number align-center">4</div>
              <div class="text">{{ $t('Confirmation of an order') }}:</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row mb15 mt20">
          <div class="col-xs-12">
            ...
            <div class="row">
              ...
              <base-checkbox
                class="col-xs-11 col-sm-12 col-md-8 bg-cl-secondary p15 mb35 custom-checkbox"
