  ...
  data () {
    return {
      ...
      ico: {
        ...
        869: `<svg width="24" height="24" viewBox="0 0 24 24" fill="#1A1919" xmlns="http://www.w3.org/2000/svg">
        ...
        869: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M19.5 11C19.5 12.6896 18.9432 14.2459 18.0008 15.5H5.99925C5.05678 14.2459 4.5 12.6896 4.5 11C4.5 6.85786 7.85786 3.5 12 3.5C16.1421 3.5 19.5 6.85786 19.5 11ZM4.22545 16.4609C3.13833 14.9161 2.5 13.0326 2.5 11C2.5 5.75329 6.75329 1.5 12 1.5C17.2467 1.5 21.5 5.75329 21.5 11C21.5 13.0326 20.8617 14.9161 19.7745 16.4609L20.9286 20.5L21.5 22.5H19.42H4.58003H2.5L3.07143 20.5L4.22545 16.4609ZM6.0086 17.5L5.15146 20.5H18.8485L17.9914 17.5H6.0086Z" fill="#BDBDBD"/>
                <rect x="10.5" y="18" width="2" height="2" fill="#BDBDBD"/>
                <rect x="14.5" y="18" width="2" height="2" fill="#BDBDBD"/>
                <path d="M8.44871 11.8724L10.1502 10.1709H11.3291V11.3498L9.62756 13.0513L10.5763 14L12 12.5763L13.4237 14L14.3725 13.0513L12.6709 11.3498V10.1709H13.8498L15.5513 11.8724L16.5 10.9237L15.0763 9.5L16.5 8.07626L15.5513 7.12755L13.8498 8.82906H12.6709V7.65022L14.3725 5.94871L13.4237 5L12 6.42374L10.5763 5L9.62756 5.94871L11.3291 7.65022V8.82906H10.1502L8.44871 7.12755L7.5 8.07626L8.92374 9.5L7.5 10.9237L8.44871 11.8724Z" fill="#BDBDBD"/>
              </svg>`
      },
