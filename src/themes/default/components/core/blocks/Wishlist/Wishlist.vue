<template>
  <div class="wishlist cl-accent">
    ...
    <div class="row middle-xs px40 wishlist-header wishlist-header-wrapper">
      ...
      <clear-wishlist-button v-if="productsInWishlist.length" @click="clearWishlist" class="end-sm clear-btn" />
    </div>
