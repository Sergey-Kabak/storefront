  ...
  <div class="custom-select" ref="select">
    ...
    <div v-if="open" class="options-wrap">
      ...
      >
        ...
        <svg v-if="selected.terms === option.terms" class="icon-checked" width="16" height="12" viewBox="0 0 16 12"
             fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            d="M5.50016 9.50033L2.00016 6.00033L0.833496 7.16699L5.50016 11.8337L15.5002 1.83366L14.3335 0.666992L5.50016 9.50033Z"
            fill="#23BE20"/>
        </svg>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    clickOutOfBlock (e) {
      if (typeof window && window.innerWidth > 576) {
        let isBlock = false
        for (let k in e.path) {
          if (e.path[k] === this.$refs.select) {
            isBlock = true
          }
        }
        if (!isBlock) {
