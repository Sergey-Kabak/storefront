  ...
  >
    <div class="item" v-if="!isOnCompare">
      <slot name="not-active-compare-icon">
        <svg style="padding: 4px" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#BDBDBD">
    ...
    <div class="item" v-else>
      <slot name="active-compare-icon">
        <svg  style="padding: 4px" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#23BE20">
...
export default {
  ...
  methods: {
    ...
    async addProduct (product) {
      const compareProduct = await this.$store.dispatch('product/loadProduct', { parentSku: product.sku })
