<template>
  ...
  >
    <slot name="icon-compare-disabled" v-if="!isOnCompare">
    ...
    <slot name="icon-compare-active" v-if="isOnCompare" >
    ...
    <slot name="text-compare-active" v-if="isOnCompare"></slot>
    <slot name="text-compare-disabled" v-if="!isOnCompare" ></slot>
  </button>
</template>
