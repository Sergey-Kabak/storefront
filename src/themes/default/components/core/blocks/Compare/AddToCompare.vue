<template>
  ...
  >
    <div class="item" v-if="!isOnCompare">
      <svg class="icon-compare" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#BDBDBD">
    ...
    <div class="item" v-if="isOnCompare">
      <svg class="icon-compare" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#23BE20">
