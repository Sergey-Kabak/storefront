<template>
  <div class="product-card-bottom-options">
    <router-link :to="productLink" class="ml-auto">
      ...
      >
        <svg v-if="!isProductInCart" class="basket-icon" width="24" height="24" viewBox="0 0 24 24" fill="#23BE20;" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg v-else class="basket-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg v-if="isProductInCart" class="check-icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
